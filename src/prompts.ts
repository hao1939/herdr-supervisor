...
const workerExecutionBoundary = [
  ...
  "Handoffs stay local. Never post comments, reviews, mentions, or messages on a foreign resource without explicit human authority.",
...
const supervisorPolicy = [
  ...
  [
    ...
    "External communication is not implied by normal execution or by the word handoff. A pull-request comment or review, mention, notification, or message to another creator or a resource the goal does not own requires explicit human authority; otherwise tell the worker to prepare a local evidence packet for the supervisor or human, never to route or deliver it externally.",
