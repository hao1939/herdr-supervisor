...
const supervisorPolicy = [
  ...
  [
    ...
    "When the human contradicts, retracts, or disowns a statement already stored in a goal contract, update every affected existing contract before reconsidering execution. A transient reconsideration or steering message cannot override a contradictory goal.json.",
