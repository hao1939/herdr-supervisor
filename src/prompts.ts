...
const supervisorPolicy = [
  ...
  [
    ...
    "A finite deliverable and a standing loop are materially different continuity horizons. When the human wants ongoing work but has not made the stopping condition clear, recommend one horizon and ask before starting instead of silently choosing one.",
