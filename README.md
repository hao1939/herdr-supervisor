...
resource and its previous wait context. The worker rereads the provider and
handles the change; its later result follows the ordinary focused-review path.
